...
public static class NpcSpellInventoryCollection {
    ...
    /// <param name="npcSpellInventory">The NPC spell inventory containing the list of spells.</param>
    ...
    public static bool TryGetNpcInventory(ulong templateID, out NPCSpellInventory npcSpellInventory) 
        => SpiralDB.TryGetNpcSpellInventory(templateID, out npcSpellInventory);

    /// <summary>
    /// Preloads the NPC spell inventories.
