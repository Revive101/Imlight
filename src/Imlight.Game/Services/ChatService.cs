...
namespace Imlight.Game.Services
{
    ...
    {
        private const string FEMALE_SOURCE_PREFIX = "80";
        private const string MALE_SOURCE_PREFIX = "82";
        ...
        private byte[] CraftSourceNameFromIndices(uint input, TypeCache.eGender gender)
        {
            ...
            var newMsb = gender == TypeCache.eGender.Female ? FEMALE_SOURCE_PREFIX : MALE_SOURCE_PREFIX;
