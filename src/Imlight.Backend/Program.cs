...
namespace Imlight.Backend
{
    internal class Program
    {
        ...
        private static ActorSystem _loginSystem;
        private static ActorSystem _gameSystem;
        private static ActorSystem _patchSystem;
        ...
        {
            _loginSystem = ActorSystem.Create(LOGIN_SERVER_NAME);
            ...
            var tcpActor = _loginSystem.ActorOf(tcpListenerProps);
