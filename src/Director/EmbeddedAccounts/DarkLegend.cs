...
internal sealed class DarkLegend : EmbeddedAccount {
    public DarkLegend(string Username, string plaintextPassword, string Email, AuthLevel AuthLevel)
    ...
    protected override Wizard CreateDefaultWizard() {
        ...
        newCharacter.SetNameOverride("DarkLegend");
