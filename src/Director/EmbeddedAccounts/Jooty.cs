...
internal sealed class Jooty : EmbeddedAccount {
    ...
    protected override Wizard CreateDefaultWizard() {
        var charCreationinfo = new WizardCharacterCreationInfo {
            ...
            m_schoolOfFocus = (uint) MagicSchool.Life,
            m_name = "Jay",
        };
        ...
        newCharacter.AddItemToInventory(191286, out var robe);
        newCharacter.AddItemToInventory(191296, out var boots);
        newCharacter.AddItemToInventory(1561150, out var staff);
