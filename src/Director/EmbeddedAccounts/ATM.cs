...
internal sealed class ATM : EmbeddedAccount {
    public ATM(string Username, string plaintextPassword, string Email, AuthLevel AuthLevel)
    ...
    protected override Wizard CreateDefaultWizard() {
        ...
        newCharacter.SetNameOverride("ATM");
