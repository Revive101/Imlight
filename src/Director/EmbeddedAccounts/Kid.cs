...
internal sealed class Kid : EmbeddedAccount {
    public Kid(string Username, string plaintextPassword, string Email, AuthLevel AuthLevel)
    ...
    protected override Wizard CreateDefaultWizard() {
        ...
        newCharacter.AddItemToInventory(1418947, out var robe);
        newCharacter.AddItemToInventory(1475466, out var boots);
        newCharacter.AddItemToInventory(1446570, out var staff);
