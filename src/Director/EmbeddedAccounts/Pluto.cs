...
internal sealed class Pluto : EmbeddedAccount {
    public Pluto(string Username, string plaintextPassword, string Email, AuthLevel AuthLevel)
    ...
    protected override Wizard CreateDefaultWizard() {
        ...
        newCharacter.SetNameOverride("Pluto");
