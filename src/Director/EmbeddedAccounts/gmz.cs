...
internal sealed class GMZ : EmbeddedAccount {
    public GMZ(string Username, string plaintextPassword, string Email, AuthLevel AuthLevel)
    ...
    protected override Wizard CreateDefaultWizard() {
        ...
        newCharacter.SetNameOverride("GMZ");
