...
internal sealed class Griz : EmbeddedAccount {
    public Griz(string Username, string plaintextPassword, string Email, AuthLevel AuthLevel)
    ...
    protected override Wizard CreateDefaultWizard() {
        ...
        newCharacter.SetNameOverride("Grizzy Wizzy");
