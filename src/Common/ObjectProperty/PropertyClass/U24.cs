...
public struct U24 : IConvertible {
    ...
    public U24(uint value) => _value = value;
    public U24(int value) => _value = (uint)value;

    public static explicit operator U24(int value) => new U24(value);
    public static implicit operator int(U24 bits) => (int)bits._value;
    public static explicit operator U24(uint value) => new U24(value);
    public static implicit operator uint(U24 bits) => bits._value;
