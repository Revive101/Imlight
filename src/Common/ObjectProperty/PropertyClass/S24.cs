...
public struct S24 : IConvertible {
    private int _value;

    public int Value { readonly get => _value; set => _value = value; }
    public S24(int value) => _value = value;

    public static explicit operator S24(int value) => new S24(value);
    public static implicit operator int(S24 bits) => bits._value;
    ...
    public readonly ulong ToUInt64(IFormatProvider? provider) => (ulong)_value;
