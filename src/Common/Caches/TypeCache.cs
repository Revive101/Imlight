...
public sealed partial class TypeCache {
	...
	public static Imlight.Common.ObjectProperty.PropertyReflection.PropertyClass Dispatch(uint hash) {
		switch (hash) {
			...
			case 89693479: return new LootRarity();
			...
			case 565894404: return new MagicWeavingTomeOption();
			...
			case 755839751: return new ClientPlatformUser();
			...
			case 768045859: return new SpellIngredient();
			...
			case 814646514: return new SpellFusionListControl();
			...
			case 903447185: return new BackpackBuddyEquipmentOptions();
			...
			case 924584657: return new BackpackBuddyHousingOptions();
			...
			case 1006965807: return new ReqHasSecondarySchool();
			...
			case 1026647568: return new MagicWeavingTomeBehaviorBase();
			...
			case 1035038433: return new MagicWeavingTomeBehavior();
			...
			case 1059252047: return new ReqIsSecondarySchool();
			...
			case 1079287052: return new LootRarityList();
			...
			case 1381891467: return new SpellFusionTemplate();
			...
			case 1417535949: return new BackpackBuddyOptions();
			...
			case 1504840843: return new HostableTournamentList();
			...
			case 1567024062: return new BackpackBuddySchoolOptions();
			...
			case 1704465025: return new ReqBaseHasBadge();
			...
			case 1747921746: return new MagicWeavingTomeBehaviorTemplate();
			...
			case 1826138975: return new MagicWeavingEntry();
			...
			case 1886842262: return new BracketHostingRequest();
			...
			case 1914260867: return new HatchmakingDonatedPetList();
	...
	public class LootRarity : PropertyClass {

		public override uint GetHash() => 89693479;
		[Property(2253792108, 2097183)] public RarityType m_rarity;
		[Property(1008695306, 31)] public GID m_lootGid;
		[Property(1011900742, 23)] public Single m_expectedValue;
		[Property(1850495755, 23)] public Single m_expectedChance;
	}
	...
	public class BasicChatPlayer : PropertyClass {
		...
		[Property(1303407771, 7)] public Char m_platformType;
		[Property(1785030215, 7)] public Boolean m_disableCrossPlay;
	}
	...
	public class MatchRequest : PropertyClass {
		...
		[Property(77702610, 31)] public GID m_accountID;
	...
	public class GoalCompleteLogic : PropertyClass {
		...
		[Property(1209220805, 7)] public Int32 m_requiredORCount;
	}
	...
	public class PvPMatchJoinQueueRequirements : PropertyClass {
		...
		[Property(3575941115, 31)] public RequirementList m_explicitBadgeRequirements;
		[Property(1958134391, 31)] public ByteString m_explicitBadgeReqDesc;
	}
	...
	public class AdventurePartyJoinInfo : PropertyClass {
		...
		[Property(695833705, 7)] public Int32 m_adventurePartyNameLocale;
	...
	public class MatchTemplate : CoreTemplate {
		...
		[Property(713306342, 7)] public Boolean m_updateBattlePassPoints;
		[Property(1252337240, 7)] public Int32 m_battlePassWinPoints;
		[Property(1400839869, 7)] public Int32 m_battlePassLosePoints;
	}
	...
	public class ReqHangingAura : ConditionalSpellEffectRequirement {
		...
		public enum kSpellEffects {
			...
			kCloakedCharm = 42,
			kCloakedWard = 43,
			kCloakedWardNoRemove = 86,
			kConfusionBlock = 109,
			kCritBlock = 47,
			kCritBoost = 46,
			kCritBoostSchoolSpecific = 97,
			kDampen = 68,
			kDispel = 40,
			kDispelBlock = 108,
			...
			kModifyIncomingDamageFlat = 119,
			kModifyIncomingDamageOverTime = 137,
			kModifyIncomingDamageType = 25,
			kModifyIncomingHeal = 24,
			kModifyIncomingHealFlat = 118,
			kModifyIncomingHealOverTime = 138,
			kModifyIncomingStealHealth = 32,
			kModifyOutgoingArmorPiercing = 30,
			kModifyOutgoingDamage = 27,
			kModifyOutgoingDamageFlat = 121,
			kModifyOutgoingDamageType = 29,
			kModifyOutgoingHeal = 28,
			kModifyOutgoingHealFlat = 120,
			kModifyPipRoundRate = 110,
			kModifyPowerPipChance = 77,
			kPipConversion = 45,
			kPowerPipConversion = 100,
			kProtectBeneficial = 103,
			kProtectHarmful = 104,
			kPushCharm = 8,
			kRemoveCombatTriggerList = 88,
			kStunBlock = 79,
			kStunResist = 44,
		}
	...
	public class PvPMatchInfo : ArenaMatchInfo {
		...
		[Property(713306342, 31)] public Boolean m_updateBattlePassPoints;
		[Property(1252337240, 31)] public Int32 m_battlePassWinPoints;
		[Property(1400839869, 31)] public Int32 m_battlePassLosePoints;
	}
	...
	public class BracketInfo : PropertyClass {
		...
		[Property(755440391, 63)] public Boolean m_playerHosted;
		[Property(2414365177, 63)] public ByteString m_hostNameBlob;
		[Property(1867250187, 31)] public Int32 m_hostingCrownsCost;
		[Property(1892563081, 63)] public GID m_creatorAccountGID;
		[Property(297782057, 63)] public Boolean m_allowOnlyOneBracketToForm;
	...
	public class ClientWizPlayerNameBehavior : NameOverrideBehavior {
		...
		[Property(656991008, 31)] public Int32 m_guildNameLocale;
	}
	...
	public class MagicWeavingTomeOption : ServiceOptionBase {

		public override uint GetHash() => 565894404;
	}
	...
	public class ClientPlatformUser : PropertyClass {

		public override uint GetHash() => 755839751;
		[Property(3429548237, 7)] public ByteString m_platformID;
		[Property(2242885711, 7)] public WideByteString m_displayName;
	}
	...
	public class SpellIngredient : PropertyClass {

		public override uint GetHash() => 768045859;
		[Property(3429518154, 7)] public ByteString m_adjective;
	}
	...
	public class GuildAchievementData : PropertyClass {
		...
		[Property(656991008, 7)] public Int32 m_guildNameLocale;
	...
	public class BadgeTemplate : CoreTemplate {
		...
		[Property(1891065348, 7)] public Boolean m_forceRequirementsCheck;
	}
	...
	public class SpellFusionListControl : SpellListControl {

		public override uint GetHash() => 814646514;
		[Property(1856724800, 7)] public Point m_ingredientSize;
		[Property(2794695056, 7)] public Point m_ingredientSpacing;
	}
	...
	public class DuelModifierTemplate : CoreTemplate {
		...
		[Property(1319414240, 31)] public Boolean m_showOnRulesDescription;
		...
		[Property(3270854131, 131103)] public ByteString m_modifierIcon;
	}
	...
	public class BackpackBuddyEquipmentOptions : PropertyClass {

		public override uint GetHash() => 903447185;
		[Property(692971815, 7)] public Boolean m_includeHats;
		[Property(1323347506, 7)] public Boolean m_includeRobes;
		[Property(1304387422, 7)] public Boolean m_includeBoots;
		[Property(1328787028, 7)] public Boolean m_includeWands;
		[Property(1385638394, 7)] public Boolean m_includeAthames;
		[Property(1127494706, 7)] public Boolean m_includeAmulets;
		[Property(1323145018, 7)] public Boolean m_includeRings;
		[Property(1306386529, 7)] public Boolean m_includeDecks;
		[Property(1945468375, 7)] public Boolean m_includeElixirs;
	}
	...
	public class IgnoreEntryData : PropertyClass {
		...
		[Property(1300871393, 31)] public Int32 m_platformType;
	}
	...
	public class BackpackBuddyHousingOptions : PropertyClass {

		public override uint GetHash() => 924584657;
		[Property(519951249, 7)] public Boolean m_includeCastleBlocks;
		[Property(596498422, 7)] public Boolean m_includePlantLife;
		[Property(720249270, 7)] public Boolean m_includeWallHangings;
		[Property(1182210829, 7)] public Boolean m_includeTileWallpaper;
		[Property(192313891, 7)] public Boolean m_includeOutdoor;
		[Property(15665371, 7)] public Boolean m_includeFurniture;
		[Property(1389489247, 7)] public Boolean m_includeDecoration;
		[Property(623905255, 7)] public Boolean m_includeMusicalScrolls;
		[Property(1324177291, 7)] public Boolean m_includeSeeds;
	}
	...
	public class TournamentConfig : PropertyClass {
		...
		[Property(3380381851, 7)] public ByteString m_playerHostableTournamentsFilename;
		[Property(929234839, 7)] public UInt32 m_minLevelToHostTournament;
		[Property(1059274119, 7)] public UInt32 m_maxPlayerHostedTournaments;
		[Property(1231114864, 7)] public UInt32 m_minBeforeHostedCanStartMinutes;
		[Property(848949298, 7)] public UInt32 m_maxBeforeHostedCanStartMinutes;
	}
	...
	public class ReqHasSecondarySchool : Requirement {

		public override uint GetHash() => 1006965807;
		[Property(1765721963, 31)] public ByteString m_secondarySchool;
	}
	...
	public class MagicWeavingTomeBehaviorBase : BehaviorInstance {

		public override uint GetHash() => 1026647568;
	}
	...
	public class MagicWeavingTomeBehavior : MagicWeavingTomeBehaviorBase {

		public override uint GetHash() => 1035038433;
	}
	...
	public class CombatParticipant : PropertyClass {
		...
		[Property(1159570481, 25)] public Boolean m_needToCleanAuras;
	...
	public class PetFeedingRewardConfig : PropertyClass {
		...
		[Property(1823724497, 7)] public List<ByteString> m_petDonatingLootTables;
	}
	...
	public class ReqIsSecondarySchool : ConditionalSpellEffectRequirement {

		public override uint GetHash() => 1059252047;
	...
	public class LootRarityList : PropertyClass {

		public override uint GetHash() => 1079287052;
		[Property(444353250, 31)] public List<LootRarity> m_loot;
	}
	...
	public class MagicSchoolTemplate : CoreTemplate {
		...
		[Property(2758948314, 7)] public List<ByteString> m_secondarySchoolBadgeList;
	}
	...
	public class WizGameStats : PropertyClass {
		...
		[Property(479424797, 31)] public UInt32 m_secondarySchool;
		[Property(1785030215, 31)] public Boolean m_disableCrossPlay;
	}
	...
	public class LootInfoList : PropertyClass {
		...
		[Property(3268854573, 31)] public LootRarityList m_lootRarityList;
	}
	...
	public class SpellEffect : PropertyClass {
		...
		public enum kSpellEffects {
			...
			kDelayCast = 49,
			kModifyCardCloak = 50,
			kModifyCardDamage = 51,
			kModifyCardAccuracy = 53,
			kModifyCardMutation = 54,
			kModifyCardRank = 55,
			kModifyCardArmorPiercing = 56,
			kSummonCreature = 65,
			kTeleportPlayer = 66,
			kStun = 67,
			kDampen = 68,
			...
			kAfterlife = 82,
			kDeferredDamage = 83,
			kDamagePerTotalPipPower = 84,
			kModifyCardHeal = 52,
			kModifyCardCharm = 57,
			kModifyCardWard = 58,
			kModifyCardOutgoingDamage = 59,
			kModifyCardOutgoingAccuracy = 60,
			kModifyCardOutgoingHeal = 61,
			kModifyCardOutgoingArmorPiercing = 62,
			kModifyCardIncomingDamage = 63,
			kModifyCardAbsorbDamage = 64,
			kCloakedWardNoRemove = 86,
			kAddCombatTriggerList = 87,
			kRemoveCombatTriggerList = 88,
			kBacklashDamage = 89,
			...
			kShadowSelf = 92,
			kShadowCreature = 93,
			kModifyShadowCreatureLevel = 94,
			kSelectShadowCreatureAttackTarget = 95,
			kShadowDecrementTurn = 96,
			kCritBoostSchoolSpecific = 97,
			kSpawnCreature = 98,
			kUnPolymorph = 99,
			kPowerPipConversion = 100,
			kProtectCardBeneficial = 101,
			kProtectCardHarmful = 102,
			kProtectBeneficial = 103,
			kProtectHarmful = 104,
			kDivideDamage = 105,
			kCollectEssence = 106,
			...
			kConfusionBlock = 109,
			kModifyPipRoundRate = 110,
			kMaxHealthDamage = 112,
			kUntargetable = 114,
			kMakeTargetable = 115,
			kForceTargetable = 116,
			kRemoveStunBlock = 117,
			kExitCombat = 122,
			kSuspendPips = 123,
			kResumePips = 124,
			kAutoPass = 125,
			...
			kTaunt = 131,
			kPacify = 132,
			kRemoveTargetRestriction = 133,
			kConvertHangingEffect = 134,
			kAddSpellToDeck = 135,
			kAddSpellToHand = 136,
			kModifyIncomingDamageOverTime = 137,
			kModifyIncomingHealOverTime = 138,
			kModifyCardDamagebyRank = 139,
			kPushConvertedCharm = 140,
			kStealConvertedCharm = 141,
			kPushConvertedWard = 142,
			kStealConvertedWard = 143,
			kPushConvertedOverTime = 144,
			kStealConvertedOverTime = 145,
			kRemoveConvertedCharm = 146,
			kRemoveConvertedWard = 147,
			kRemoveConvertedOverTime = 148,
			kModifyOverTimeDuration = 149,
			kModifySchoolPips = 150,
		}
	...
	public class MessageBoardMessage : PropertyClass {
		...
		[Property(104095035, 7)] public Int32 m_partyNameLocale;
	...
	public class SpellFusionTemplate : CoreTemplate {

		public override uint GetHash() => 1381891467;
		[Property(1286746870, 7)] public UInt32 m_templateID;
		[Property(3553984419, 134217735)] public ByteString m_debugName;
		[Property(3023276954, 8388615)] public ByteString m_displayKey;
		[Property(2967855037, 7)] public List<ByteString> m_adjectives;
		[Property(1337011809, 7)] public SpellIngredient m_primaryIngredient;
		[Property(2076393285, 7)] public SpellIngredient m_secondaryIngredient;
	}
	...
	public class BackpackBuddyOptions : PropertyClass {

		public override uint GetHash() => 1417535949;
		[Property(264897697, 7)] public Boolean m_sellCrownsItems;
		[Property(521218229, 7)] public Boolean m_sellNoAuctionItems;
		[Property(1261254173, 7)] public Boolean m_sellStitchedItems;
		[Property(661884604, 7)] public Boolean m_sellCosmeticItems;
		[Property(1195509291, 7)] public Boolean m_sellItemsWithJewels;
		[Property(1963747469, 7)] public BackpackBuddySchoolOptions m_equipmentRequirementSchools;
		[Property(882949685, 7)] public Int32 m_equipmentLevelDifference;
		[Property(875757928, 7)] public BackpackBuddyEquipmentOptions m_equipmentLevelCategories;
		[Property(1546271990, 7)] public Int32 m_equipmentDuplicateCount;
		[Property(616694667, 7)] public BackpackBuddyEquipmentOptions m_equipmentDuplicateCategories;
		[Property(1837351132, 7)] public Boolean m_sellEmptyDecks;
		[Property(1610059564, 7)] public Boolean m_sellTemporaryMounts;
		[Property(2030133551, 7)] public BackpackBuddyHousingOptions m_sellAllHousingCategories;
		[Property(1475507737, 7)] public Boolean m_keepSkeletonKeys;
		[Property(1977825738, 7)] public Boolean m_keepGuildGateKeys;
		[Property(418836224, 7)] public Boolean m_keepSocketWrenches;
		[Property(1849469010, 7)] public Boolean m_keepGauntletsOneShotDungeons;
		[Property(164534196, 7)] public Boolean m_keepQuintecentCores;
		[Property(1924786069, 7)] public Boolean m_keepCrownSeeds;
		[Property(545140859, 7)] public Int32 m_housingDuplicateCount;
		[Property(1794770481, 7)] public BackpackBuddyHousingOptions m_sellHousingDuplicateCategories;
		[Property(3468556638, 7)] public BackpackBuddySchoolOptions m_libraryTreasureCardSchools;
		[Property(1921259619, 7)] public Int32 m_treasureCardDuplicateCount;
		[Property(3246907172, 7)] public BackpackBuddySchoolOptions m_treasureCardDuplicateSchools;
		[Property(1661696866, 7)] public Boolean m_sellAllGardeningTC;
		[Property(221153712, 7)] public Boolean m_sellAllCastleMagicTC;
		[Property(815472644, 7)] public Boolean m_sellAllCantripTC;
		[Property(2852898436, 7)] public BackpackBuddySchoolOptions m_sellAllJewelSchools;
		[Property(9285909, 7)] public Int32 m_jewelDuplicateCount;
		[Property(2024509716, 7)] public BackpackBuddySchoolOptions m_sellAllPinSchools;
		[Property(17477605, 7)] public Int32 m_pinDuplicateCount;
		[Property(947085848, 7)] public Boolean m_sellBlockJewels;
		[Property(1662439960, 7)] public Boolean m_sellCriticalJewels;
		[Property(575425784, 7)] public Boolean m_sellAccuracyJewels;
		[Property(1422401486, 7)] public Boolean m_sellFlatResistJewels;
		[Property(1076082387, 7)] public Boolean m_sellFlatDamageJewels;
		[Property(1056576185, 7)] public Boolean m_sellIncomingHealingJewels;
		[Property(769504177, 7)] public Boolean m_sellOutgoingHealingJewels;
		[Property(895258275, 7)] public Boolean m_sellHealthJewels;
		[Property(497642570, 7)] public Boolean m_sellManaJewels;
		[Property(1610892139, 7)] public Boolean m_sellGivesSpellJewels;
		[Property(1304798563, 7)] public Boolean m_sellDerbyJewels;
	}
	...
	public class HostableTournamentList : PropertyClass {

		public override uint GetHash() => 1504840843;
		[Property(1419131309, 31)] public List<BracketInfo> m_brackets;
	}
	...
	public class BackpackBuddySchoolOptions : PropertyClass {

		public override uint GetHash() => 1567024062;
		[Property(429321305, 7)] public Boolean m_balance;
		[Property(794256793, 7)] public Boolean m_death;
		[Property(221862713, 7)] public Boolean m_fire;
		[Property(269518980, 7)] public Boolean m_ice;
		[Property(222077939, 7)] public Boolean m_life;
		[Property(222131765, 7)] public Boolean m_myth;
		[Property(812599848, 7)] public Boolean m_storm;
		[Property(258319322, 7)] public Boolean m_astral;
		[Property(949013689, 7)] public Boolean m_shadow;
	}
	...
	public class BracketRequest : PvPMatchRequest {
		...
		[Property(297782057, 31)] public Boolean m_allowOnlyOneBracketToForm;
		[Property(1796488605, 31)] public List<ByteString> m_pvpDuelModifiers;
	...
	public class ReqBaseHasBadge : Requirement {

		public override uint GetHash() => 1704465025;
		[Property(3002948047, 31)] public ByteString m_badgeName;
	}
	...
	public class MagicWeavingTomeBehaviorTemplate : BehaviorTemplate {

		public override uint GetHash() => 1747921746;
		[Property(3544827053, 7)] public List<MagicWeavingEntry> m_magicWeavingEntryList;
		[Property(2840985510, 7)] public RequirementList m_requirements;
	}
	...
	public class MagicWeavingEntry : PropertyClass {

		public override uint GetHash() => 1826138975;
		[Property(3002948047, 7)] public ByteString m_badgeName;
		[Property(219803942, 7)] public Int32 m_rank;
		[Property(2939095653, 8388615)] public ByteString m_badgeDisplayName;
		[Property(2141570098, 8388615)] public ByteString m_badgeDescription;
	}
	...
	public class SpellTemplate : CoreTemplate {
		...
		[Property(1803268236, 7)] public ByteString m_secondarySchoolName;
		[Property(1658928321, 7)] public UInt32 m_spellFusion;
		[Property(3576058981, 7)] public ByteString m_requiredSchoolName;
	...
	public class BracketHostingRequest : PropertyClass {

		public override uint GetHash() => 1886842262;
		[Property(1606554576, 31)] public GID m_hostCharacterID;
		[Property(305762000, 31)] public GID m_hostAccountID;
		[Property(2414365177, 31)] public ByteString m_hostNameBlob;
		[Property(770430570, 31)] public GID m_hostingRequestID;
		[Property(1799846440, 31)] public UInt32 m_tournamentNameID;
		[Property(902119808, 31)] public GID m_hostableBracketScheduleID;
		[Property(485853727, 31)] public UInt32 m_hostingTimeOffset;
		[Property(2116250681, 31)] public UInt32 m_hostClientTime;
		[Property(3410693808, 2097183)] public TournamentHostingPrivacy m_tournamentHostingPrivacy;

		public enum TournamentHostingPrivacy {
	...
	public class HatchmakingDonatedPetList : PropertyClass {

		public override uint GetHash() => 1914260867;
		[Property(2532790655, 7)] public List<ByteString> m_donatedPetList;
	}
	...
	public class PromoGift : PropertyClass {
		...
		[Property(665366430, 31)] public Boolean m_autoRedeem;
	}
	...
	public class AuctionHouseConfig : PropertyClass {
		...
		[Property(977195955, 7)] public List<UInt32> m_templatesInStockList;
	}
	...
	public enum eRace {
		...
		PP_WinterGoblin = 2025052443,
		PP_OnyxAnubis = 1552575189,
		PP_OttomanCat = 223541582,
		MNT_HolidayYeti = 780983974,
		MNT_IceSled = 979912604,
		MNT_TurtleDoves = 1850191638,
		MNT_KrokChariot = 559783620,
		MNT_Mustang = 1775949401,
		MNT_PumpkinBall = 382849054,
		Transformation_BG_Fairy_Storm = 836920873,
		Transformation_BG_Elf_Myth = 1506493664,
		Transformation_NinjaPig_Life = 816802847,
		Transformation_BG_Krok_Fire = 1060580712,
		Transformation_BG_Colossus_Balance = 1067963041,
		Transformation_BG_NinjaPig_Life = 441460895,
		PP_Penguin_03 = 1623028104,
		Transformation_Duck_Librarian_B = 864067551,
		Transformation_Duck_Librarian_A = 859873247,
		Transformation_Duck_Adventurer = 194560769,
		Transformation_Gummy_Bunny_C = 1298087941,
		Transformation_Frog_Horned_A = 837201339,
		Transformation_Glowbug_Storm = 2096380446,
		Transformation_Marshmallow_Critter_A = 1036335317,
		Transformation_Snipe_Base_B = 232132109,
		Transformation_Snowball = 915248481,
		Transformation_Wombat_Base = 333435450,
		Transformation_Human_Malistaire = 1414887773,
		Transformation_Morganthe_E = 1745180054,
		Transformation_Spider_Grandfather = 1131773979,
		Transformation_Khrulhu_Dasein_B = 367878762,
		Transformation_Devourer_Base = 698770016,
		Transformation_Alien_Meteor = 638746168,
		Transformation_Nightmare_Malus = 704212821,
		Transformation_Daemon_Personal = 278266463,
		PP_ValentinesDay = 810003364,
		PP_BabyHippo = 422858138,
		PP_Aardwold = 1592150119,
		PP_Aardwold_C = 1902528613,
		MNT_Cobra = 472847981,
		MNT_Serpopard = 1629558909,
		MNT_Serpopard_B = 1629556867,
		MNT_Serpopard_C = 1629556931,
		PP_Fairy_Fire = 1847789544,
		...
		MNT_Wheelbarrow = 614248817,
		Transformation_Weasel_Minstrel_B = 1807062039,
		Transformation_RavenMystic_B = 1443192915,
		Transformation_EagleHunter_D = 601718010,
		Transformation_ElephantWarrior_B = 873591975,
		Transformation_Gorilla_Soldier_B = 1664574928,
		Transformation_WolfScout_B = 1890913411,
		Transformation_BG_RatThief_Ice = 1423718331,
		Transformation_BG_Cyclops_Myth = 638471808,
		MNT_CuteSpider_A = 620731472,
		MNT_CelestialMoon_D = 30544056,
		MNT_CelestialMoon_E = 97652920,
		PP_ColossusBalance = 1413933927,
		PP_Parakeet = 514843272,
		PP_TwinkleStars_B = 764278811,
		PP_TwinkleStars_C = 764213275,
		PP_BearOwl = 105393244,
		MNT_StubbornLlama = 221089074,
		MNT_Drorse = 1717019758,
		MNT_Dandelion = 957181222,
		PP_ChineseNYSnake_B = 1257847852,
		PP_FrogCottage = 183055543,
	}
