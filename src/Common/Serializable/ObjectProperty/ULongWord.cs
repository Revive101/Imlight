...
public struct ULongWord : IConvertible
{
    ...
    public ULongWord(uint value) => _value = value;
    public ULongWord(int value) => _value = (uint)value;

    public static explicit operator ULongWord(int value) => new ULongWord(value);
    public static implicit operator int(ULongWord bits) => (int)bits._value;
    public static explicit operator ULongWord(uint value) => new ULongWord(value);
    public static implicit operator uint(ULongWord bits) => bits._value;
