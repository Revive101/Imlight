...
internal class Definitions
{
    internal class ClassDef
    {
        ...
        public ClassDef(XmlNode node)
        {
            ...
            this.Hash = StringHash.Compute(rawName);
    ...
    internal class PropertyDef
    {
        ...
        private static readonly IReadOnlyDictionary<string, Type> InternalTypeTranslationDict 
            = new Dictionary<string, Type>()
            {
                ...
                { "u24",              typeof(ULongWord)      }, // 24-bit unsigned integer
            };
        ...
        public PropertyDef(XmlNode node)
        {
            try
            {
                ...
                this.Hash = StringHash.HashPropertyName(rawName, unparsedType);
