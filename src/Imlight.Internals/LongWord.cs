...
{
    public struct LongWord : IConvertible
    {
        private int _value;

        public int Value { get => _value; set => _value = value; }
        public LongWord(int value) => _value = value;

        public static explicit operator LongWord(int value) => new LongWord(value);
        public static implicit operator int(LongWord bits) => bits._value;
