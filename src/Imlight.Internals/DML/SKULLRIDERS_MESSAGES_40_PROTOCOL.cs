...
namespace Imlight.Internals.DML
{
    ...
    public sealed class SKULLRIDERS_MESSAGES_40_PROTOCOL : INetworkProtocol
    {
        ...
        public sealed class MSG_SKULLRIDERS_CONNECT : INetworkRecord
        {
            public byte MessageOrder { get; } = 1;
        }
        public sealed class MSG_SKULLRIDERS_MOVED : INetworkRecord
        {
            public byte MessageOrder { get; } = 2;
        }
        public sealed class MSG_SKULLRIDERS_REWARDS : INetworkRecord
        {
